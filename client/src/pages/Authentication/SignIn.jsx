  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/api/v1/auth/signin', {
        ...
        body: JSON.stringify(inputs) // The request body as a JSON string
      })
      ...
      // Call the signIn function with the token and user state and save the user state in the cookies
      signIn({
        auth: {
          token: data.token,
          type: 'Bearer'
