          ...
          <nav className='mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
            ...
            <div>
              ...
              <ul className='mb-6 flex flex-col gap-1.5'>
                ...
                <li>
                  <a
                    className='group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark2 duration-300 ease-in-out  cursor-pointer hover:text-meta-1 hover:bg-meta-1 hover:bg-opacity-10'
