      ...
      <div className='z-2 max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto text-black dark:text-white'>
        ...
        <div className='z-2 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-3 lg:gap-6 items-center'>
          <div className='relative p-4 md:p-7 bg-gray-100 rounded-lg dark:text-white group'>
            ...
            <svg className='min-w-16 w-[40%] py-3 lg:py-5  h-auto  mx-auto text-amber-500 dark:text-white' width='26' height='30' viewBox='0 0 26 30' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div className='relative p-4 md:p-7 bg-gray-100 rounded-lg dark:text-white group'>
            <div className='absolute w-[100%] -bottom-2 flex left-0'>
              <span className='group-hover:opacity-100 opacity-0 transition duration-100 delay-300 group-hover:delay-0 ease-in-out absolute -top-1 left-1/2 block h-2 w-2 -translate-x-1/2 rotate-45 bg-black dark:bg-white' />
              <span className='group-hover:opacity-100 opacity-0 transition duration-500 group-hover:delay-300  ease-in-out rounded-md bg-black px-3.5 py-1.5 text-custom-sm text-white group-hover:block dark:bg-white dark:text-black text-center mx-auto'>React</span>
            </div>

            <svg className='min-w-22 w-[43%] py-3 lg:py-5  h-auto  mx-auto text-sky-500 dark:text-white' width='36' height='40' viewBox='0 0 36 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div className='relative p-4 md:p-7 bg-gray-100 rounded-lg text-sky-500 dark:text-white group'>
            ...
            <svg className='min-w-20 w-[41%] py-3 lg:py-5  h-auto  mx-auto text-sky-500 dark:text-white' width='26' height='26' viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div className='p-4 md:p-7 bg-gray-100 rounded-lg dark:text-white relative group'>
            ...
            <svg className='min-w-21 w-[50%] py-3 lg:py-5  h-auto  mx-auto text-sky-500 dark:text-white' xmlns='http://www.w3.org/2000/svg' width='64' height='64' viewBox='0 0 32 32' preserveAspectRatio='xMidYMid'>
              ...
              <ul className='space-y-2 sm:space-y-4'>
                ...
                <li className='flex space-x-3'>
                  ...
                  <span className='text-sm sm:text-base text-gray-800 dark:text-white'>
                    <span className='font-bold text-2xl'>Easy designing fast</span>
                    <p className='text-black dark:text-white mt-2'>
                      Besides working with start-up enterprises as a partner for digitalization, we have built enterprise products for common pain points that we have encountered in various products and projects.
                    </p>
                  </span>
