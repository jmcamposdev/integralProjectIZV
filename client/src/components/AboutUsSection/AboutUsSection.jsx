...
const AboutUSSection = () => {
  return (
    <section className='relative py-17.5 sm:py-22.5 xl:py-27.5 bg-white dark:bg-boxdark flex flex-col gap-[2.5rem] font-medium leading-relaxed font-satoshi bg-primary text-white bg-gray  text-black dark:text-white justify-center items-center'>

      <div className='z-1 max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto text-black dark:text-white'>
        ...
        <div className='mt-16 aspect-w-16 aspect-h-7'>
        ...
        <div className='sm:w-1/2 xl:w-1/2 mx-auto text-center mb-6 mt-12'>
          <h2 className='text-gray-800 font-bold text-4xl dark:text-white'>Developers at these companies and institutes love us</h2>
        </div>

        <div className='grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-3 lg:gap-6 items-center'>
          <div className='relative p-4 md:p-7 bg-gray-100 rounded-lg dark:text-white group'>
            <div className='absolute w-[100%] -bottom-5 flex left-0'>
              <span className='group-hover:block hidden absolute -top-1 left-1/2 block h-2 w-2 -translate-x-1/2 rotate-45 bg-black dark:bg-white' />
              <span className='group-hover:block hidden rounded-md bg-black px-3.5 py-1.5 text-custom-sm text-white group-hover:block dark:bg-white dark:text-black text-center mx-auto'>HTML 5</span>
            </div>

            <svg className='min-w-22 w-[40%] py-3 lg:py-5  h-auto  mx-auto text-amber-500 dark:text-white' width='26' height='30' viewBox='0 0 26 30' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div className='relative p-4 md:p-7 bg-gray-100 rounded-lg dark:text-white group'>
            <div className='absolute w-[100%] -bottom-2 flex left-0'>
              <span className='group-hover:block hidden absolute -top-1 left-1/2 block h-2 w-2 -translate-x-1/2 rotate-45 bg-black dark:bg-white' />
              <span className='group-hover:block hidden rounded-md bg-black px-3.5 py-1.5 text-custom-sm text-white group-hover:block dark:bg-white dark:text-black text-center mx-auto'>React</span>
            </div>

            <svg className='min-w-28 w-[50%] py-3 lg:py-5  h-auto  mx-auto text-sky-500 dark:text-white' width='36' height='40' viewBox='0 0 36 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div className='relative p-4 md:p-7 bg-gray-100 rounded-lg text-sky-500 dark:text-white group'>
            <div className='absolute w-[100%] -bottom-5 flex left-0'>
              <span className='group-hover:block hidden absolute -top-1 left-1/2 block h-2 w-2 -translate-x-1/2 rotate-45 bg-black dark:bg-white' />
              <span className='group-hover:block hidden rounded-md bg-black px-3.5 py-1.5 text-custom-sm text-white group-hover:block dark:bg-white dark:text-black text-center mx-auto'>Tailwind</span>
            </div>

            <svg className='min-w-28 w-[50%] py-3 lg:py-5  h-auto  mx-auto text-gray-800 dark:text-white' width='37' height='22' viewBox='0 0 37 22' fill='none' xmlns='http://www.w3.org/2000/svg'><path fill-rule='evenodd' clip-rule='evenodd' d='M18.1923 0C13.341 0 10.309 2.44444 9.09615 7.33333C10.9154 4.88889 13.0378 3.97222 15.4635 4.58333C16.8474 4.93167 17.8365 5.94407 18.9314 7.06377C20.715 8.88827 22.7795 11 27.2885 11C32.1397 11 35.1718 8.55556 36.3846 3.66667C34.5654 6.11111 32.4429 7.02778 30.0173 6.41667C28.6333 6.06833 27.6442 5.05593 26.5493 3.93623C24.7658 2.11173 22.7013 0 18.1923 0ZM9.09615 11C4.24487 11 1.21282 13.4444 0 18.3333C1.81923 15.8889 3.94167 14.9722 6.36731 15.5833C7.75127 15.9323 8.74039 16.9441 9.8353 18.0638C11.6188 19.8883 13.6833 22 18.1923 22C23.0436 22 26.0756 19.5556 27.2885 14.6667C25.4692 17.1111 23.3468 18.0278 20.9211 17.4167C19.5372 17.0683 18.5481 16.0559 17.4532 14.9362C15.6696 13.1117 13.6051 11 9.09615 11Z' fill='currentColor' /></svg>
          </div>

          <div className='relative p-4 md:p-7 bg-gray-100 rounded-lg text-sky-500 dark:text-white group'>
            <div className=' absolute w-[100%] -bottom-5 flex left-0 '>
              <span className='absolute -top-1 left-1/2 block h-2 w-2 -translate-x-1/2 rotate-45 bg-black dark:bg-white group-hover:block hidden' />
              <span className='hidden group-hover:block rounded-md bg-black px-3.5 py-1.5 text-custom-sm text-white group-hover:block dark:bg-white dark:text-black text-center mx-auto'>JavaScript</span>
            </div>

            <svg className='min-w-20 w-[50%] py-3 lg:py-5  h-auto  mx-auto text-sky-500 dark:text-white' width='26' height='26' viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div className='p-4 md:p-7 bg-gray-100 rounded-lg dark:text-white relative group'>
            <div className='absolute w-[100%] -bottom-5 flex left-0'>
              <span className='group-hover:block hidden absolute -top-1 left-1/2 block h-2 w-2 -translate-x-1/2 rotate-45 bg-black dark:bg-white' />
              <span className='group-hover:block hidden rounded-md bg-black px-3.5 py-1.5 text-custom-sm text-white group-hover:block dark:bg-white dark:text-black text-center mx-auto'>Node JS</span>
            </div>
            <svg className='min-w-24 w-[50%] py-3 lg:py-5  h-auto  mx-auto text-sky-500 dark:text-white' xmlns='http://www.w3.org/2000/svg' width='64' height='64' viewBox='0 0 32 32' preserveAspectRatio='xMidYMid'>
      ...
      <div className='text-black dark:text-white z-1 max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto'>
