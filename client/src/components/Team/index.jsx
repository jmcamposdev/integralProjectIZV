        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col rounded-xl p-4 md:p-6 border dark:border-form-strokedark border-stroke dark:bg-boxdark text-black black:text-white'>
            ...
            <div className='mt-3 space-x-1'>
              ...
              <a className='hover:border text-black dark:text-white border-stroke inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg  border-gray-200  hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600' href='/'  aria-label='Github'>
              ...
              <a className='hover:border text-black dark:text-white border-stroke inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg  border-gray-200  hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600' href='/'  aria-label='Twitter'>
          ...
          <a className='flex-col justify-center text-center hover:shadow-sm flex rounded-xl p-4 md:p-6 border dark:border-form-strokedark border-stroke dark:bg-boxdark2 text-black black:text-white' href='/'  aria-label='Hiring'>
